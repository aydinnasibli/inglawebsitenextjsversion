...
import {
    ChevronRight, ChevronLeft, Baby, Star, Info, CheckCircle2,
    PlayCircle, Trophy, Check, ZoomIn, X, ArrowRight,
    ClipboardList, Phone, Mail, Gamepad2, CreditCard, Calendar, Clock,
} from 'lucide-react';
                        ...
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                            ...
                            {service.isFeatured && (
                                <span className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-primary text-slate-900 text-xs font-bold uppercase tracking-widest">
                                    <Star className="w-3.5 h-3.5 fill-slate-900" />Populyar
                                </span>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {service.gallery.map((img, idx) => (
                                    ...
                                    >
                                        <Image src={img.url} alt={img.alt || `Gallery ${idx + 1}`} fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw" className="object-cover group-hover:scale-105 transition-transform duration-500" />
