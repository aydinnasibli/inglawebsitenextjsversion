...
import { ChevronRight, Award, BarChart2, ArrowRight, UserCog, MonitorPlay, TrendingUp } from 'lucide-react';
        ...
        <div className="flex-1 bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100">
            ...
            <section className="mb-16 bg-slate-50 dark:bg-slate-800/30 rounded-2xl p-8 md:p-10">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                    {[
                        { Icon: UserCog,     title: "Sahə Ekspertləri",    desc: "Öz sahəsində magistr və ya daha yüksək dərəcəli peşəkar təlimçilər." },
                        { Icon: MonitorPlay, title: "Əyani & Online",      desc: "Mərkəzdə və ya onlayn — sizin üçün uyğun formatı seçin." },
                        { Icon: TrendingUp,  title: "İnkişafın İzlənməsi", desc: "Həftəlik hesabatlar və mütəmadi fərdi məsləhətləşmələr." },
                    ].map(({ Icon, title, desc }) => (
